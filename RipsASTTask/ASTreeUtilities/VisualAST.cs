  ...
  public  class VisualAST
    {
        ...
        public IASTreeNode ASTreeNode { get; private set; }

        public VisualAST(IASTreeNode astTreeNode)
        {
            ASTreeNode = astTreeNode;
        }
        ...
        {
            int center;
            Image image = Draw(this.ASTreeNode, out center);
            return image;
        }

        private Image Draw(IASTreeNode astTreeNode, out int center)
        {
